...
const CACHE = "primerka-v6";
const FILES = ["./", "index.html", "styles.css", "app.js", "data.js", "data-more.js", "manifest.webmanifest", "icons/icon.svg", "icons/icon-192.png", "icons/icon-512.png"];
